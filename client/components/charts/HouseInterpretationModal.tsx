//components/charts/HouseInterpretationModal.tsx
...
export type HouseInterpretationPage = {
  key: string
  title: string
...
type Props = {
  visible: boolean
  pages: HouseInterpretationPage[]
  currentIndex: number
  onChangeIndex: (index: number) => void
  onClose: () => void
}

export default function HouseInterpretationModal({
  visible,
  pages,
  currentIndex,
  onChangeIndex,
  ...
  const pagerPages = useMemo<HouseInterpretationPage[]>(() => {
      ...
      <View style={styles.overlay}>
        ...
        <View style={styles.sheet}>
          <View style={styles.headerRow}>
            ...
            <Text style={styles.headerTitle}>House Interpretation</Text>
